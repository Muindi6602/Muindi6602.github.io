    ...
    <div class="card-body">
        <form action="" id="sale-form">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <label class="control-label text-info">Sale number</label>
                ...
                <hr>
                <fieldset>
                    <legend class="text-info">Sell here</legend>
                    <div class="row justify-content-center align-items-end">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="unit" class="control-label">Unit (Enter 1 )</label>
                        ...
                        <div class="col-md-2 text-center">
                            <div class="form-group">
                                <button type="button" class="btn btn-flat btn-sm btn-primary" id="add_to_list">Sell Now</button>
                            </div>
                        </div>
                </fieldset>
                <hr>
                <a href="mpesa" style="background-color: green; color: white; padding: 8px 15px; border: none; border-radius: 5px; font-size: 10px; text-decoration: none; display: inline-block;">Pay</a>
<br><br>
                <table class="table table-striped table-bordered" id="list">
                    ...
                    <thead>
                        <tr class="text-light bg-navy">
                            ...
                            <th class="text-center py-1 px-2">Unit(1)</th>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                        <label for="remarks" class="text-info control-label">Remarks<br><span style="color: red;">Did the customer pay on Mpesa, Cash, Paybill or on Credit?</span></label>
    ...
    <button class="btn btn-flat btn-primary" type="submit" form="sale-form" style="background-color: green; color: white;">Complete</button>
